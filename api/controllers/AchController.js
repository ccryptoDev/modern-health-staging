const inconmeTestJson = {
	"Card": {
		"average_monthly_free_cash_flow": 7558.14,
		"account_age_days": Math.floor(Math.random() * (0 - 500) + 0),
		...
		"sum_employer_income_current_month": 2500.00,
		"sum_employer_income_previous_month": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_2_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_3_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_4_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_5_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_6_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_7_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_8_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_9_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_10_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_11_months_ago": Math.floor(Math.random() * (0 - 7500.00) + 0),
		"sum_employer_income_12_months_ago": 10000.00,
		...
		"sum_employer_income": 97500.00,
		"sum_government_income_90_days": 12400.00,
		"sum_government_income_current_month": 1550.00,
		"sum_government_income_previous_month": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_2_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_3_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_4_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_5_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_6_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_7_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_8_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_9_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_10_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_11_months_ago": Math.floor(Math.random() * (0 - 4500) + 0),
		"sum_government_income_12_months_ago": 6200.00,
		...
		"sum_employment_insurance_income_90_days": 400.00,
		"sum_social_assistance_income_90_days": 800.00,
		"sum_wsib_income_90_days": 800.00,
		"sum_pension_income_90_days": 800.00,
		"sum_child_support_income_government_90_days": 4800.00,
		"sum_other_income_90_days": 4000.00,
		"sum_total_credits_current_month": 4450.00,
		"sum_total_credits_previous_month": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_2_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_3_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_4_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_5_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_6_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_7_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_8_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_9_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_10_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_11_months_ago": Math.floor(Math.random() * (0 - 13350) + 0),
		"sum_total_credits_12_months_ago": 17800.00
	},
	"Login": {
	...
	"RequestId": "144b89a5-aed3-4bf0-8ed9-7f83c25e8fbf"
}

const creditRiskJson = {
	"Card": {
		"average_monthly_free_cash_flow": 7558.14,
	...
	"RequestId": "e44b9c98-c723-4dca-a66c-6faa46ac872e"
}

const userAnalysisJson = {
	"Card": {
		"account_age_days": 387,
		"employer_name": "Flinks Technologies",
		"average_monthly_employer_income_complex": 7708.33,
...
function executeBTRs(assetReport, practiceSetting) {
	let rules = {};
	//rule e_r_1  
	...
	const checkerValue = practiceSetting.btrs.rules[0].value || 2000;
	rules.btr1 = { passed: income_6mon_avg < checkerValue ? false : true, value: income_6mon_avg.toFixed(2) };
	...
	const checkerValue2 = practiceSetting.btrs.rules[1].value || 0;
	rules.btr2 = { passed: nsf_in_1m_cnt > checkerValue2 ? false : true, value: nsf_in_1m_cnt.toFixed(2) };
	...
	const checkerValue3 = practiceSetting.btrs.rules[2].value || 2;
	rules.btr3 = { passed: nsf_in_3m_cnt > checkerValue3 ? false : true, value: nsf_in_3m_cnt.toFixed(2) };
	...
	const checkerValue4 = practiceSetting.btrs.rules[3].value || 400;
	rules.btr4 = { passed: avg_depository_6mon <= checkerValue4 ? false : true, value: (!Number.isNaN(avg_depository_6mon) ? avg_depository_6mon.toFixed(2) : 0.00) };
	...
	const checkerValue5 = practiceSetting.btrs.rules[4].value || 200;
	rules.btr5 = { passed: bal_avail_depository <= checkerValue5 ? false : true, value: (!Number.isNaN(bal_avail_depository) ? bal_avail_depository.toFixed(2) : 0.00) };
	...
	const checkerValue6 = practiceSetting.btrs.rules[5].value || 50;
	rules.btr6 = { passed: (bal_avail_depository < checkerValue6 && bal_avail_depository && positive_days_depository_1mon < 20 && positive_days_depository_1mon) ? false : true, value: (!Number.isNaN(bal_avail_depository) ? bal_avail_depository.toFixed(2) : 0.00) };
	...
	const checkerValue7 = practiceSetting.btrs.rules[6].value || 200;
	rules.btr7 = { passed: (avg_depository_3mon < checkerValue7 && avg_depository_3mon && avg_credit_3mon > 500 && avg_credit_3mon) ? false : true, value: (!Number.isNaN(avg_depository_3mon) ? avg_depository_3mon.toFixed(2) : 0.00) };
	...
	const checkerValue8 = practiceSetting.btrs.rules[7].value || 1000;
	rules.btr8 = { passed: (income_6mon_amount < checkerValue8 && income_6mon_amount) ? false : true, value: income_6mon_amount.toFixed(2) };
	...
	const checkerValue9 = practiceSetting.btrs.rules[8].value || 179;
	rules.btr9 = { passed: (days_since_old_trans < checkerValue9) ? false : true, value: days_since_old_trans.toFixed(2) };
	...
	const checkerValue10 = practiceSetting.btrs.rules[9].value || -1000;
	rules.btr10 = { passed: (ck_acc_bal_avg < checkerValue10) ? false : true, value: (!Number.isNaN(ck_acc_bal_avg) ? ck_acc_bal_avg.toFixed(2) : 0.00) };
	...
	const checkerValue11 = practiceSetting.btrs.rules[10].value || 0;
	rules.btr11 = { passed: (payment_amt_90d > checkerValue11 && (payment_amt_90d.toFixed(2) / 90)) > 10.0 ? false : true, value: payment_amt_90d > 0 ? "" + (payment_amt_90d.toFixed(2) / 90) + "%" : "0.00%" };
	...
	const checkerValue12 = practiceSetting.btrs.rules[11].value || 0;
	rules.btr12 = { passed: (spending_amount_in_30d < checkerValue12 || !spd_pos_cnt_30d) ? false : true, value: spending_amount_in_30d.toFixed(2) };
	...
	const checkerValue13 = practiceSetting.btrs.rules[12].value || 50;
	rules.btr13 = { passed: (bkf_cnt_90d < checkerValue13) ? false : true, value: bkf_cnt_90d.toFixed(2) };
	...
	const checkerValue14 = practiceSetting.btrs.rules[13].value || 1000;
	rules.btr14 = { passed: (total_atm_fees_amt > checkerValue14) ? false : true, value: total_atm_fees_amt.toFixed(2) };
									...
									.then((accountDetail) => {
										...
										Achdocuments.find(doccriteria)
											...
											.then(function (documentdata) {
												...
												UserConsent.find(pdfCriteria).then(function (pdfdocuments) {
													// Bad but urgent solution
													let foundRetailInstallmentContract = 0;
													let pdfdocument = [];
													if (pdfdocuments) {
														_.each(pdfdocuments, function (documemts) {
															if (documemts.agreementpath) {
																documemts.agreementpath = Utils.getS3Url(documemts.agreementpath);
															}
															if (documemts.documentName == "Retail Installment Contract") {
																foundRetailInstallmentContract += 1;
															}
															if (documemts.documentName == "Retail Installment Contract" && foundRetailInstallmentContract == 1) {
																pdfdocument.push(documemts);
															} else if (documemts.documentName != "Retail Installment Contract") {
																pdfdocument.push(documemts);
															}
														});
													}
																																		...
																																		.then(function (uid) {
																																			EmploymentHistory.queryEmploymentHistory(uid[0].user)
																																				.then(function (employmentInfo) {
																																					...
																																					PlaidAssetReport.find({ user: paymentmanagementdata.screentracking.user }).limit(1).then((assetReport) => {
																																						const practiceSettingCriteria = {};
																																						if (screenPracticeRes.practicemanagement.practiceSetting) {
																																							practiceSettingCriteria.id = screenPracticeRes.practicemanagement.practiceSetting;
																																						} else {
																																							practiceSettingCriteria.isDefault = true;
																																						}
																																						PracticeSetting.findOne(practiceSettingCriteria).then((practiceSetting) => {
																																							const bankrules = (assetReport[0] && paymentmanagementdata.screentracking.rulesDetails) ? executeBTRs(assetReport[0], practiceSetting) : [];
																																							const btrHasLength = !assetReport[0] ? false : true;
																																											...
																																											UserConsent.objectdataforpdf(userconsentid, req, res)
																																												.then(function (objectdatas) {
																																													return UserConsent.find({ user: userconsentid, screenid: paymentmanagementdata.screentracking.id }).then((userconsents) => {
																																														...
																																														_.forEach(userconsents, function (userconsent, index) {
																																															...
																																															sails.log.warn("userconsent #" + index, userconsent);
																																														});
																																														if (!creditReportConsentExists) {
																																															...
																																															return Transunionhistory.findOne({ user: user.id })
																																																.then(async (transunionhistory) => {
																																																	...
																																																	const pdfString = _.get(creditBureau, "product.embeddedData._val");
																																																	if (pdfString) {
																																																...
																																																.finally(() => {
																																																	...
																																																	let incomeObject = [];
																																																	let indx = 0;
																																																	for (incomeItem in inconmeTestJson.Card) {
																																																		if (typeof incomeItem !== "object") {
																																																			let keyName = Object.keys(inconmeTestJson.Card)[indx];
																																																			let reg = new RegExp("_", "g")
																																																			let formattedKeyName = keyName.replace(reg, " ");
																																																			const formatedItem = { name: formattedKeyName, value: inconmeTestJson.Card[keyName] };
																																																			incomeObject.push(formatedItem);
																																																			indx++;
																																																		}
																																																	}
																																																	...
																																																	let creditObject = [];
																																																	for (creditItem in creditRiskJson.Card) {
																																																		if (typeof creditItem !== "object") {
																																																			let keyName = Object.keys(creditRiskJson.Card)[indx];
																																																			let reg = new RegExp("_", "g")
																																																			let formattedKeyName = keyName.replace(reg, " ");
																																																			const formatedItem = { name: formattedKeyName, value: creditRiskJson.Card[keyName] };
																																																			creditObject.push(formatedItem);
																																																			indx++;
																																																		}
																																																	}
																																																	...
																																																	indx = 0;
																																																	let userObject = [];
																																																	sails.log.warn("formatting 2 . . .")
																																																	for (userItem in userAnalysisJson.Card) {
																																																		if (typeof userItem !== "object") {
																																																			let keyName = Object.keys(userAnalysisJson.Card)[indx];
																																																			let reg = new RegExp("_", "g")
																																																			let formattedKeyName = keyName.replace(reg, " ");
																																																			const formatedItem = { name: formattedKeyName, value: userAnalysisJson.Card[keyName] };
																																																			userObject.push(formatedItem);
																																																			indx++;
																																																		}
																																																	}

																																																	FlinksService.getUserAttributes(paymentmanagementdata.screentracking.user).then((flinksattributes) => {
																																																		fs.unlink(pdfFilePath, () => { });
																																																		const responsedata = {
																																																			flinksattributes: flinksattributes,
																																																			inconmeTestJson: inconmeTestJson,
																																																			incomeObject: incomeObject,
																																																			userObject: userObject,
																																																			creditObject: creditObject,
																																																			creditRiskJson: creditRiskJson,
																																																			userAnalysisJson: userAnalysisJson,
																																																			userconsents: userconsents,
																																																			interestRate: creditTier.interestRate24 || 50.0,
...
function completeApplication(req, res) {
	...
	const paymentManagementPromise = viewtype == "denied" ? PaymentManagement.find(options).populate("user").populate("practicemanagement").populate("screentracking").sort({ createdAt: "desc" }).limit(1000) : PaymentManagement.find(options).populate("user").populate("practicemanagement").populate("screentracking");
		...
		.exec(function (err, paymentmanagementdata) {
			...
			if (req.query.sSearch) {
				...
				paymentmanagementdata = _.filter(paymentmanagementdata, function (item) {
					...
					if (item.user.firstname != null && item.user.lastname != null) {
